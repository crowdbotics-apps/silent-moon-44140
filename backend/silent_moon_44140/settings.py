"""
Django settings for silent_moon_44140 project.
...
ROOT_URLCONF = 'silent_moon_44140.urls'
...
WSGI_APPLICATION = 'silent_moon_44140.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_moon_44140 API",
    "DESCRIPTION": "API documentation for silent_moon_44140 App",
    "VERSION": "v1",
}
